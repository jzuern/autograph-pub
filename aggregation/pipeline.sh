...
for CITY in "${CITIES[@]}"; do
  for ((tid=1; tid<=NUM_PARALLEL; tid++)); do
    ...
    ~/anaconda3/envs/geometric/bin/python aggregate_av2.py --city_name $CITY\
                                                           --out_path_root /data/autograph/test-austin/$CITY/lanegraph \
...
#                                         ~/anaconda3/envs/geometric/bin/python aggregate_av2.py --city_name $CITY\
#                                                           --out_path_root /data/autograph/test-austin/$CITY/tracklets_raw \
#                                                           --sat_image_root /data/lanegraph/woven-data \
...
#
#                                       ~/anaconda3/envs/geometric/bin/python aggregate_av2.py --city_name $CITY\
#                                                           --out_path_root /data/autograph/test-austin/$CITY/tracklets_joint \
#                                                           --sat_image_root /data/lanegraph/woven-data \
