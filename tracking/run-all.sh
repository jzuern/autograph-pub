...
#(cd OpenPCDet/tools && $PYTHON demo.py --cfg_file $CFG --ckpt $CKPT --ext .feather --av2_root /data/argoverse2-full/lidar/test/)

#(cd OpenPCDet/tools && $PYTHON demo.py --cfg_file $CFG --ckpt $CKPT --ext .feather --av2_root /data/argoverse2-full/lidar/val/)
#(cd OpenPCDet/tools && $PYTHON demo.py --cfg_file $CFG --ckpt $CKPT --ext .feather --av2_root /data/argoverse2-full/lidar/train/)
...
$PYTHON tracking.py --av2_root /data/argoverse2-full/lidar/test/
$PYTHON tracking.py --av2_root /data/argoverse2-full/lidar/val/
$PYTHON tracking.py --av2_root /data/argoverse2-full/lidar/train/
